...
public class generaldonate extends JFrame {
	...
	public void degine() {
		...
		label_6.setIcon(new ImageIcon(generaldonate.class.getResource("/picture/search.jpg")));
		label_6.setBounds(453, 155, 24, 22);
		contentPane.add(label_6);
		
		searchCB = new JComboBox();
		searchCB.setModel(new DefaultComboBoxModel(new String[] {"Search catagory...", "Book_Name", "Writer_Name", "Owner_Contact"}));
		searchCB.setBounds(243, 159, 141, 22);
		contentPane.add(searchCB);
		
		searchTF = new JTextField();
		searchTF.setColumns(10);
		searchTF.setBounds(477, 155, 135, 22);
		...
		label_3.setToolTipText("To know us detail go to about");
