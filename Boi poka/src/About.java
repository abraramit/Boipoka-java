...
public class About extends JFrame {
	...
	public void degine(){
		...
		txtpnAldfkjsdfjAkdflkjlaksdjflkKjldkfjlkasjdfl.setText("In the 21th century, online shop has become the philopher's stone. The necessity of books to every level of people and the advantages of online store has emerged the project Boipoka as the a most potential one.\r\n\r\nBoipoka is an software, where the customer can get books easily. A customer can search a book through book title or writers or even through publication, add his booklist and finaly purchase the book. He can sell his books and also can donate them to others. In this software there are some fun games are also avaiable.\r\n\r\nFor this project our group members are\r\n\r\nAbrar Khan\r\nMd. tawhidul islam\r\nMd. Raiyan hossain\r\nMst. Tazma khatun\r\nMd. Maraj-ul-islam");
		txtpnAldfkjsdfjAkdflkjlaksdjflkKjldkfjlkasjdfl.setBounds(189, 174, 483, 402);
		...
		JLabel lblARoomWithout = new JLabel("A room without books is like a body without a soul.");
		lblARoomWithout.setToolTipText("Marcus Tullius Cicero");
		lblARoomWithout.setFont(new Font("Segoe Print", Font.PLAIN, 16));
		lblARoomWithout.setBounds(189, 139, 424, 38);
		contentPane.add(lblARoomWithout);
	}
}
