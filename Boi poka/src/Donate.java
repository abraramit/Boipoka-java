...
public class Donate extends JFrame {
	...
	public void degine() {
		...
		label_8.setIcon(new ImageIcon(Donate.class.getResource("/picture/search.jpg")));
		label_8.setBounds(459, 153, 24, 22);
		...
		btnDonate.setToolTipText("To add books press this");
		...
		searchTF.setBounds(488, 155, 147, 20);
