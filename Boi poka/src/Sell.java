...
private void resetEverything() {
	...
	public void degine(){
		...
		button_2.setToolTipText("To add books press this");
		...
		label_10.setIcon(new ImageIcon(Sell.class.getResource("/picture/search.jpg")));
		label_10.setBounds(445, 132, 24, 30);
		...
		Datatable.setToolTipText("Your all selllist will show in here.");
