...
public class Wishlist extends JFrame {
	...
	public void degine() {
		...
		lblNewLabel.setIcon(new ImageIcon(Wishlist.class.getResource("/picture/search.jpg")));
		lblNewLabel.setBounds(456, 157, 24, 22);
		...
		datatable.setToolTipText("Your all wishlist will show in here.");
		scrollPane.setViewportView(datatable);
		
		JButton button_7 = new JButton("Add");
		button_7.setToolTipText("To add books press this");
