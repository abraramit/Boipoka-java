...
public class Generalsell extends JFrame {
	...
	public void degine() {
		...
		searchCB.setBounds(240, 144, 148, 26);
		...
		datatable.setToolTipText("Your all sell bookslist will show in here.");
		...
		label_5.setToolTipText("To know us detail go to about");
		...
		label_6.setIcon(new ImageIcon(Generalsell.class.getResource("/picture/search.jpg")));
		label_6.setBounds(441, 144, 24, 22);
