...
public class userhome extends JFrame {
	...
	public void degine() {
		...
		label_1.setToolTipText("To know us detail go to about.");
		...
		label.setToolTipText("To know us detail go to about");
		...
		scrollPane.setToolTipText("Your all bookslist will show in here.");
		scrollPane.setBounds(199, 164, 486, 172);
		contentPane.add(scrollPane);
		
		datatable = new JTable();
		datatable.setToolTipText("Your all bookslist will show in here.");
		scrollPane.setViewportView(datatable);
		
		JButton btnAdd = new JButton("Add");
		btnAdd.setToolTipText("To add books press this");
		...
		label_7.setIcon(new ImageIcon(userhome.class.getResource("/picture/search.jpg")));
		label_7.setBounds(448, 127, 24, 26);
		...
		searchCB.setModel(new DefaultComboBoxModel(new String[] {"Search catagory...", "Book_Name", "Writer_Name", "Publication", "price"}));
