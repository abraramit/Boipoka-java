...
public class genaralabout extends JFrame {
	...
	public void degine() {
		...
		JTextPane txtpnInTheth = new JTextPane();
		txtpnInTheth.setBackground(new Color(224, 255, 255));
		txtpnInTheth.setText("In the 21TH century, online shop has become the philopher's stone. The necessity of books to every level of people and the advantages of online store has emerged the project Boipoka as the a most potential one.\r\n\r\nBoipoka is an software, where the customer can get books easily. A customer can search a book through book title or writers or even through publication, add his booklist and finaly purchase the book. He can sell his books and also can donate them to others. In this software there are some fun games are also avaiable.\r\nFor this project our group members are\r\nAbrar Khan\r\nMd tawhidul islam\r\nRaiyan hossain\r\nMst. Tazma khatun\r\nMd. Maraj-ul-islam");
		txtpnInTheth.setFont(new Font("Tahoma", Font.PLAIN, 16));
		txtpnInTheth.setEditable(false);
		txtpnInTheth.setBounds(191, 135, 483, 326);
		contentPane.add(txtpnInTheth);
		...
		JLabel label_5 = new JLabel("A room without books is like a body without a soul.");
		label_5.setToolTipText("Marcus Tullius Cicero");
		label_5.setFont(new Font("Segoe Print", Font.PLAIN, 16));
		label_5.setBounds(191, 99, 424, 38);
